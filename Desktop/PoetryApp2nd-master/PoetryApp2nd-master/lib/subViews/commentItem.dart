...
// Author: Ervin, Birol
// This file deals with the creation of the comment bubbles themselves, and thus this file just receives data and creates
// the resulting comment bubble.
...
class _CommentItem extends State<CommentItem> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      // The comment bubble is created here
            ...
            children: <Widget>[
              Padding(
                ...
                child: Container(
                    ...
                    child: Image.asset(
                        'images/${widget.data['userThumbnail']}')), // we used to have it so that your profile image
                // would show here, but it was buggy so we stopped messing with it
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: <Widget>[
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                              onTap: () {
                                widget.replyComment([
                                  // this function creates the reply comment bubble
                                  widget.data['userName'],
                                  widget.data['commentID'],
