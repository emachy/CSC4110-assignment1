...
// Authors: Ervin, Khaled
// This program creates the poem cards for the Notebook page.  Look at the threadItem.dart for more documentation.

class ThreadItemNotebook extends StatefulWidget {
...
class _ThreadItem extends State<ThreadItemNotebook> {
  String title = "title";
  ...
  //List<String> noteBookoption = ['General', 'Fun', 'Sad'];
...
void changeReportColor(var data) async {
  ...
  if (names.contains(uid)) {
    ...
    List<String> temp = [uid];
    data.reference.updateData({'reporters': FieldValue.arrayUnion(temp)});
  }
}
